...
import websiteDevelopmentData from '@/data/services/websiteDevelopmentData';
...
const WebsiteDevelopmentPage = () => {
  ...
  return (
    <DetailPageWrapper title={title} backHref='/services'>
      ...
      <div className='mt-12 flex justify-center gap-4 flex-wrap'>
        <button
          onClick={() => router.push(ctaPrimary.link)}
        ...
        <button
          onClick={() => router.push(ctaSecondary.link)}
