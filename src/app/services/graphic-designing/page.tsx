...
import { graphicDesignData } from '@/data/services/graphicDesignData';

const GraphicDesignPage = () => {
  const { intro, highlights, whyChoose, process, testimonial, ctas } =
    graphicDesignData;

  return (
    <DetailPageWrapper title='Graphic Designing' backHref='/services'>
