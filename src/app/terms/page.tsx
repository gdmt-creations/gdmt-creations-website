      ...
      <section className='py-16 px-6'>
        <div className='max-w-3xl mx-auto prose prose-gray prose-headings:text-gray-900 prose-p:text-gray-600 prose-li:text-gray-600'>
          ...
          <ul>
            ...
            <li>Misuse contact forms, submissions, or inquiry channels</li>
          </ul>

          <h2>3. No Automatic Service Contract</h2>
          <p>
            Use of this website, submission of an inquiry form, or exchange of preliminary communication does not by itself create a binding service agreement. A binding commercial relationship begins only when both parties agree to the relevant scope, pricing, deliverables, timelines, and payment terms, typically through a written proposal, contract, statement of work, email confirmation, or invoice acceptance.
          </p>

          <h2>4. Intellectual Property</h2>
          <p>
            Unless otherwise stated, all website content, including text, branding, graphics, logos, layouts, icons, design elements, and original website materials are owned by or licensed to Saarva and are protected by applicable intellectual property laws. You may not reproduce, republish, copy, distribute, modify, sell, exploit, or create derivative works from website content without prior written permission, except for limited personal and non-commercial viewing.
          </p>

          <h2>5. Client Materials</h2>
          <p>
            If you submit content, media, logos, documents, creative assets, or other materials to us, you represent that you own them or have the right to share them, and that their use by us for the intended project will not infringe third-party rights. You remain responsible for the legality, accuracy, and ownership of materials supplied by you.
          </p>
          ...
          <p>
            Unless otherwise agreed in writing, Saarva may display completed or published work, brand names, project excerpts, previews, thumbnails, case study summaries, or publicly available outcomes in its portfolio, social media, pitch decks, or promotional materials solely for showcasing its work. If you want this restricted, that should be specifically agreed in writing.
          </p>

          <h2>11. Disclaimer</h2>
          <p>
            This website and its content are provided on an &quot;as is&quot; and &quot;as available&quot; basis. While we make reasonable efforts to keep information accurate and current, we do not guarantee completeness, accuracy, uninterrupted access, or fitness for a particular purpose. Nothing on this website should be treated as legal, tax, financial, compliance, or professional advice unless explicitly stated otherwise.
          </p>

          <h2>12. Limitation of Liability</h2>
          <p>
            To the maximum extent permitted by law, Saarva shall not be liable for any indirect, incidental, special, consequential, reputational, or loss-of-profit damages arising out of or related to your use of the website, reliance on website information, website downtime, third-party platform interruptions, or unauthorized access despite reasonable safeguards. Where liability cannot be excluded under law, it will be limited to the extent permitted by applicable law and the relevant governing contract, if any.
          </p>

          <h2>13. Indemnity</h2>
          <p>
            You agree to indemnify and hold harmless Saarva, its partners, team members, contractors, and affiliates against claims, liabilities, damages, losses, and expenses arising from your misuse of the website, your breach of these Terms, your submitted materials, or your violation of third-party rights or applicable law.
          </p>
          ...
          <p>
            These Terms shall be governed by the laws of India. Any disputes arising from or relating to the website or these Terms shall be subject to the courts having jurisdiction at Gurugram, Haryana, unless otherwise agreed in a specific client contract.
          </p>
